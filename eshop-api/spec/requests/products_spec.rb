...
RSpec.describe 'Eshop API', type: :request do
  ...
  describe 'POST /products' do
    # valid payload
    let(:valid_attributes) { { title: 'Learn Elm', price: 1, art_nr: 1, description: ' hej'  } }
    ...
    context 'when the request is invalid' do
      ...
      it 'returns a validation failure message' do
        expect(response.body)
          .to match(/Validation failed: Price can't be blank, Art nr can't be blank, Description can't be blank/)
      end
    end
  end
